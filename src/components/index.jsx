...
export function DockerImageLink({ image, truncate = false, prefix = 20, suffix = 16 }) {
...
export function TableEmptyState({ message }) {
  return <div className="table-empty-state">{message}</div>
}

export function CopyValueButton({ value, label, copiedKey, onCopy, className = '' }) {
...
export function FooterLinkCard({ label, href, description, icon }) {
  return (
